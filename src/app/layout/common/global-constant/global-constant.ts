...
export class GlobalConst {
    ...
    public static nacionality: TypeSelectString[] = [
        ...
        { viewValue: 'boliviano' },
        { viewValue: 'bosnio' },
        { viewValue: 'brasileiro' },
        { viewValue: 'búlgaro' },
        { viewValue: 'camboyano' },
        { viewValue: 'canadiense' },
        { viewValue: 'centroafricano' },
        { viewValue: 'chino' },
        { viewValue: 'costa-riqueño' },
        { viewValue: 'croata' },
        { viewValue: 'Cubano' },
        { viewValue: 'húngaro' },
        { viewValue: 'hondureño' },
        ...
        { viewValue: 'haitiano' },
        { viewValue: 'Cubana' },
        { viewValue: 'dominicana' },
        { viewValue: 'ecuatoriana' },
        { viewValue: 'egipcia' },
        { viewValue: 'salvadoreño' },
        { viewValue: 'finlandesa' },
        { viewValue: 'francés' },
        { viewValue: 'griego' },
        { viewValue: 'guatemalteco' },
        { viewValue: 'indio' },
        { viewValue: 'indonésia' },
        { viewValue: 'iraqui' },
        { viewValue: 'irlandesa' },
    ...
    public static PorcenterRisk: TypeSelect[] = [
        { viewValue: '1', value: 0.522  },
        { viewValue: '2', value: 1.044  },
