...
@Component({
    selector: 'payroll-contractor-list.component',
    styleUrls: ['./payroll-contractor-list.component.scss'],
    templateUrl: './payroll-contractor-list.component.html',
    animations: [
    ...
    implements OnInit, OnDestroy, AfterViewInit
{
    ...
    registerPayment(data: any) {
        if (this.selection.selected.length > 0 || data != null) {
            ...
            const dialogRefPayment = this._matDialog.open(
