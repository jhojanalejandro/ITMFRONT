...
export class EstudioPrevioComponent implements OnInit {
    ...
    private generatePreviusStudy() {
        for (let index = 0; index < this.contractContractors.contractors.length; index++) {
            ...
            this.savePdfGenerated(documentPreviousStudy, data.contractorName);
    ...
    private generateCommitteeRequest() {
        for (let index = 0; index < this.contractContractors.contractors.length; index++) {
            ...
            this.savePdfGenerated(documentSolicitudComite, data.contractorName);
        }
    }
    ...
    private savePdfGenerated(pdfDocument: any, contractorName: string){
