...
export class ContractorDataHiringComponent implements OnInit, OnDestroy {
    ...
    private _initData() {
        this.formContractor = this._formBuilder.group({
            ...
            fechaFinalizacionConvenio: new FormControl(null),
            ...
            activity: new FormControl({ value: null, disabled: this.visibleActivity }),
        ...
        this._uploadService
            ...
            .subscribe((res) => {
                if (res.success) {
                    ...
                    }else if(this.activitySelectId != this.datos.activityId || this.elementselectId != this.datos.elementId ){
                        this.asignmentElement();
                    }
